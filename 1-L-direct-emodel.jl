...
function (p::EdgePolicy)(state)
    ...
    ep = cat(vertex_template_score, p.bmodel, dims = 2)
...
function (p::EdgePolicy)(states, num_batches)
    ...
    ep = cat(vertex_template_score, repeat(p.bmodel, inner = (1, 1, num_batches)), dims = 2)
...
#     gd_ret = gd_ret,
#     ylim = [0.75, 1],
#     filename = "results/supervised/edge-policy/1-L-direct-emodel.png",
# )
